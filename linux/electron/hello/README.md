# Electron hello — Linux (stub)

Scaffold with the **official** Electron release tooling for Linux.
Chromium + Node. **Do not** vendor Chromium.

## Weigh recipe (outline)

1. Minimal hello window (same spirit as Keld / Swift fixtures — one window).
2. Build a **Release** Linux pack (AppImage / deb / rpm; Chromium-class fairness.).
